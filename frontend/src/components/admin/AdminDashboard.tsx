...
const AdminDashboard = () => {
  ...
  const { data, isLoading: dashboardLoading, isError } = useAdminDashboard();
  ...
  const { productCount, pendingOrders, revenue, customerCount } = data;
  ...
  return (
    <>
      ...
      <div className="max-w-6xl p-6 mx-auto">
        <h1 className="mb-6 text-3xl font-bold">Welcome, {user.firstName} 👋</h1>

        {/* Metrics Grid */}
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">

          <div className="bg-green-50 rounded-xl border border-green-100 text-green-600 p-6 shadow-sm hover:shadow-md transition-all duration-200 group">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-4">
              <div className={`p-2.5 rounded-lg border bg-green-100 text-green-600 border-green-100`}>
          ...
          <div className="bg-blue-50 rounded-xl border border-blue-100 text-blue-600 p-6 shadow-sm hover:shadow-md transition-all duration-200 group">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-4">
              <div className={`p-2.5 rounded-lg border bg-blue-100 text-blue-600 border-blue-100`}>
      ...
      <div className="bg-purple-50 rounded-xl border border-purple-100 text-purple-600 p-6 shadow-sm hover:shadow-md transition-all duration-200 group">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-4">
              <div className={`p-2.5 rounded-lg border bg-purple-100 text-purple-600 border-purple-100`}>
          ...
          <div className="bg-orange-50 rounded-xl border border-orange-100 text-orange-600 p-6 shadow-sm hover:shadow-md transition-all duration-200 group">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-4">
              <div className={`p-2.5 rounded-lg border bg-orange-100 text-orange-600 border-orange-100`}>
          ...
          {metrics && (
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-semibold text-green-900">Peak Revenue Day</h3>
                <p className="text-sm text-green-700">Best performing day</p>
              </div>
            </div>
          ...
          {metrics && (
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-semibold text-blue-900">Peak Orders Day</h3>
                <p className="text-sm text-blue-700">Highest order volume</p>
              </div>
            </div>
            <div className="space-y-2">
