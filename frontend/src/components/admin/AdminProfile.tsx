...
import { useUpdateAdmin, useUpdateAdminEmail, useUpdateAdminPassword } from '@/hooks/useUser';
import { toast } from 'sonner';

type UpdateAdminInput = z.infer<typeof updateUserSchema>;
...
const AdminProfilePage = () => {
    ...
    const updateUserMutation = useUpdateAdmin();
    const updateEmailMutation = useUpdateAdminEmail();
    const updatePasswordMutation = useUpdateAdminPassword();
    const [originalValues, setOriginalValues] = useState<UpdateAdminInput>({
            firstName: '',
            lastName: '',
            phone: '',
            address: '',
    ...
    const onSubmitProfile = (data: UpdateAdminInput) => {
    ...
    <div className="max-w-2xl px-4 py-8 mx-auto space-y-10">
        <section>
        <h2 className="mb-4 text-xl font-bold">Admin Information</h2>
