...
container.register("ShippingRepositoryFactory", { useClass: ShippingRepositoryFactory});
container.register("DashboardRepositoryFactory", { useClass: DashboardRepositoryFactory});
...
container.register("MongoShippingRepository", { useClass: MongoShippingRepository});
container.register("MongoDashboardRepository", { useClass: MongoDashboardRepository});
...
container.register("ShippingService", { useClass: ShippingService});
...
container.register("ShippingController", { useClass: ShippingController});
