...
import { updateSellerSchema, updateSellerEmailSchema, updateSellerPasswordSchema } from "@validation/sellerValidation";
...
// seller routes
router.get('/view-profile', RoleMiddleware.hasRole('seller'), controller.getProfile.bind(controller));
router.put('/update-profile', RoleMiddleware.hasRole('seller'), new Validator(updateSellerSchema).validate(), controller.updateProfile.bind(controller));
